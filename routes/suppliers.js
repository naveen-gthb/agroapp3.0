...
router.route('/')
    ...
    //.post(catchAsync(products.register));
...
router.route('/products/:id')
    ...
    .put(isLoggedIn, /*isAuthor,*/ upload.array('image'), /*validateCampground,*/ catchAsync(products.updateProduct))
...
router.get('/equipments/:id/edit', isLoggedIn, /*isAuthor,*/ catchAsync(equipments.renderEditEquipmentForm))
