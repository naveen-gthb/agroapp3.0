...
function calculateProductTotal() {
  ...
  function searchProduct()
  {
    ...
    for (var i=0; i < prodcards.length; i++) {
      ...
      let name = prodcards[i].children[0].children[1].children[0].innerHTML;
  ...
  function searchJob()
  {
    ...
    for (var i=0; i < jobcards.length; i++) {
      ...
      let nameCity = jobcards[i].children[0].children[0].children[0].innerHTML.toLowerCase();
      let nameJob = jobcards[i].children[0].children[0].children[1].innerHTML.toLowerCase();
